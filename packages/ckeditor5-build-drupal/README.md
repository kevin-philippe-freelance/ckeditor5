...
```bash
npm install --save @ckeditor/ckeditor5-build-drupal
```
...
```js
import DrupalEditor from '@ckeditor/ckeditor5-build-drupal';

// Or using the CommonJS version:
// const DrupalEditor = require( '@ckeditor/ckeditor5-build-drupal' );
